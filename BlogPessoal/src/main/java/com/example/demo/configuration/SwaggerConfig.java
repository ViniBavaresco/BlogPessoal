...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blog Pessoal")
				...
				.licenseUrl("https://github.com/ViniBavaresco/BlogPessoal")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Vinicius Bavaresco", "https://github.com/ViniBavaresco/BlogPessoal", "vinibava03@gmail.com");
	}
